...
export default function Home() {
  ...
  const htmlContent = `
    <div class="bg-white text-black">
      ...
      <div class="px-4 text-base leading-relaxed">
        <h2 class="text-2xl font-black leading-tight mb-2 mt-4" style="font-family: 'Roboto', Arial, sans-serif;" data-testid="text-heading-participar">
        ...
        <h2 class="text-2xl font-black leading-tight mb-2 mt-4" style="font-family: 'Roboto', Arial, sans-serif;" data-testid="text-heading-beneficio">
        ...
        <h2 class="text-2xl font-black leading-tight mb-2 mt-4" style="font-family: 'Roboto', Arial, sans-serif;" data-testid="text-heading-importancia">
